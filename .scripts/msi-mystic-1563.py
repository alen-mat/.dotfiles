#!/bin/python3
# MSI Alpha keyboard is not supported by openRGB yet. This script is found in the issue below
#ISSUE    : https://gitlab.com/CalcProgrammer1/OpenRGB/-/issues/2289
#AUTHOR   : Jona Saffer @ghostshadow2601 
#ARCHWIKI : https://wiki.archlinux.org/title/Talk:Laptop/MSI
#
# Udev Rule
# ACTION=="add", SUBSYSTEM=="hidraw", ATTRS{idVendor}=="1462", ATTRS{idProduct}=="1562", TAG+="uaccess"
#
# The MYSTIC_VID and MYSTIC_PID should be changed accordingly by changing to values in the output of lsusb
# The necessary udev rules have to be added to use the script without sudo.
