...
local keypassthrough = require("utils.keypassthrough")
...
M.raw.root   = {
    ...
    layout = {
        awful.key(
            {}, 'Print', function() ss.full_screen(true) end,
            { description = 'Save desktop screenshot to file', group = 'Screenshot' }
        ),
        awful.key(
            { 'Control' }, 'Print', function() ss.full_screen(false) end,
            { description = 'Save desktop screenshot to clipboard', group = 'Screenshot' }
        ),
        ...
        -- {{ modkey, "Control" }, "k", toggle_splash,
        --     { description = "splash term", group = "Utils" }},
        awful.key({ modkey, }, "s", hotkeys_popup.show_help,
            { description = "show help", group = "awesome" }),
        awful.key({ modkey, }, "w", function() mainmenu:show() end,
            { description = "show main menu", group = "awesome" }),
        awful.key({ modkey, }, "Pause", function() keypassthrough:toggle() end,
            { description = "Forward keys", group = "awesome" }),
        awful.key({ modkey }, "x",
            function()
                awful.prompt.run {
                    prompt       = "Run Lua code: ",
...
function M:setup()
    self.keys.root = gears.table.join(
        self.raw.root.XFKeys,
        self.raw.root.layout,
        self.raw.root.tags
    )
    ...
    -- awful.keyboard.append_global_keybindings({ is better but
    root.keys(self.keys.root)

    keypassthrough:init(root.keys())
end
