...
Singleton {
  ...
  function getColorByDay() {
      ...
      switch (day[0]) {
          case "M": return "blue";    // Mon
          case "T": return day[1] === "u" ? "green" : "purple"; // Tue : Thu
          case "W": return "yellow";  // Wed
          case "F": return "orange";  // Fri
          case "S": return day[1] === "u" ? "red" : "pink"; // Sun : Sat
          default:  return "";
      }
  }
